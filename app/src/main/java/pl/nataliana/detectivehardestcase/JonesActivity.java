...
public class JonesActivity extends AppCompatActivity {
    ...
    private void prepareDialogs() {
        ...
        allDialogs.push(new Dialog(playerFace, name, getString(R.string.p3)));
        allDialogs.push(new Dialog(R.drawable.detective, getString(R.string.name_Jones), getString(R.string.j3)));
        allDialogs.push(new Dialog(playerFace, name, getString(R.string.p2, school)));
